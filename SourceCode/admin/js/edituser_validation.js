...
$(document).ready(function() {
    ...
    //On blur
//	globalpayuserid.blur(validateglobalpayuserid);
    ...
    //On key press
//	globalpayuserid.keyup(validateglobalpayuserid);
    ...
    form.submit(function() {
        if (/*validateglobalpayuserid() & */ validateoldpassword() & validatenewpassword() & validateconfirmpassword())
        {
            return true;
    ...
    functiion validateglobalpayuserid(){
        //if it's NOT valid
