 ...
 * Description - This is the php file for performing user unsubscribe based files
 * ****************************************** */
include_once('class/edituser.cls.php');
include_once('class/validation.cls.php');
$loginDetails = $_SESSION;

$_GET['user_id'] = base64_decode($_GET['user_id']);
                                        ...
                                        <?php if (isset($_POST['edituser'])): ?>
                                            <div id="error" class="valid">
                                                <ul>
                                                    ...
                                                    <?php $msg = user_unsubscription_updation($_GET['user_id'], $_POST['subscription']); ?>
                                                    <li>
